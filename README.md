...
[Website](https://o-c.do) · [Privacy](https://o-c.do/privacy) · [Terms](https://o-c.do/terms) · [TestFlight (beta)](https://testflight.apple.com/join/ZGhbsphj) · [Telegram](https://t.me/orange_cloud_channel) · [Ko-fi](https://ko-fi.com/chen2he) · [Build Guide / 自编译指南](BUILD-LOCALLY.md)

[English](#english) | [中文](#中文) | [自编译 IPA 全流程](BUILD-LOCALLY.md)
...
> 完整自编译 IPA 全流程指南（含 Cloudflare OAuth Client、回调 Worker、Secrets、编译、安装与排障，中英双语）见 **[BUILD-LOCALLY.md](BUILD-LOCALLY.md)**。
